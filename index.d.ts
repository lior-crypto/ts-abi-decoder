...
function _typeToString(input: Input): any {
...
function _addABI(abiArray: AbiItem[]) {
...
function _removeABI(abiArray: AbiItem[]) {
  if (Array.isArray(abiArray)) {
    // Iterate new abi to generate method id"s
    abiArray.map(function (abi) {
      if (abi && abi.name && abi.inputs) {
...
function _decodeMethod(data: string) {
